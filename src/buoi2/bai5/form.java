...
public class form extends javax.swing.JFrame {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtmagv, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txthoten, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnluutruActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnluutruActionPerformed
     ...
     String khoa=cbkhoa.getSelectedItem().toString();
       GiangVien gv=new GiangVien(hoten, magv, diachi, gioitinh, khoa);
       dsGiangVien.add(gv);
       StringBuilder sb=new StringBuilder();
       if(hoten.equals("")||magv.equals("")||diachi.equals("")){
           sb.append("bạn cần nhập đủ thông tin");
           
       }
       else{
           sb.append("đã lưu xong");
           try (PrintWriter pw=new PrintWriter(new File("giangvien.dat"))){
               for(GiangVien tmp:dsGiangVien){
                   pw.println(tmp.getHoten());
                    pw.println(tmp.getMagv());
                     pw.println(tmp.getDiachi());
                    pw.println(tmp.getGioitinh());
                     pw.println(tmp.getKhoa());
               }
           } catch (Exception e) {
           }
       }
       if(sb.length()>0){
           JOptionPane.showMessageDialog(this,sb.toString(),"Thông Báo",JOptionPane.NO_OPTION);
       }
